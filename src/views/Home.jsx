    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col items-center justify-center h-full text-center text-white">
          <h1 className="text-8xl md:text-8xl sm:text-6xl font-bold poppins-bold">
            Robustica
          </h1>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-lg text-gray-600 assistant-normal">Welcome to</p>
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 poppins-bold">
              Journey
            </h1>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-12">
            ...
            <div className="description text-center lg:text-left max-w-lg lg:w-1/2 bg-white bg-opacity-90 rounded-lg p-6 shadow-lg">
              ...
              <p className="text-sm md:text-lg text-gray-700 leading-relaxed">
                ...
                which gives them a unique flavor profile. The beans are
                handpicked and sun-dried, which helps to preserve their natural
                flavors. The beans are then roasted to perfection, resulting in
                a rich and full-bodied coffee that is perfect for any time of
                day.
              </p>
            </div>
          </div>
